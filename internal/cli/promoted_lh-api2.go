...
func newLhApi2PromotedCmd(flags *rootFlags) *cobra.Command {
	var flagId string
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			path := "https://livefpl-api-489391001748.europe-west4.run.app/LH_api2/planner/snapshot"
			params := map[string]string{}
			if flagId != "" {
				params["id"] = fmt.Sprintf("%v", flagId)
			}
			data, prov, err := resolveRead(cmd.Context(), c, flags, "lh-api2", false, path, params, nil)
			if err != nil {
