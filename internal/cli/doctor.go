		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if cfg != nil {
				...
				if header == "" {
					...
					report["auth_hint"] = "export FANTASY_PREMIER_LEAGUE_SESSION_COOKIE=<your-key>"
				} else {
					authConfigured = true
			...
			if os.Getenv("FANTASY_PREMIER_LEAGUE_SESSION_COOKIE") != "" || authHeader != "" {
				authEnvSet = append(authEnvSet, "FANTASY_PREMIER_LEAGUE_SESSION_COOKIE")
			} else {
				authEnvInfo = append(authEnvInfo, "FANTASY_PREMIER_LEAGUE_SESSION_COOKIE set with auth set-token")
			}
			switch {
			...
			if cfg != nil && cfg.BaseURL != "" {
				...
				if clientErr != nil {
					...
					if authHeader == "" {
						...
						authHeaders["sessionid"] = authHeader
