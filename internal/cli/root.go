...
Read-only by design. Local SQLite cache for offline lookups. Agent-friendly:
...
Run 'xfpl doctor' to verify connectivity.`,
	...
	rootCmd.AddCommand(newLeaguesClassicCmd(flags))
	...
	rootCmd.AddCommand(newBootstrapStaticPromotedCmd(flags))
	rootCmd.AddCommand(newDreamTeamPromotedCmd(flags))
	rootCmd.AddCommand(newElementSummaryPromotedCmd(flags))
	rootCmd.AddCommand(newEliteJsonPromotedCmd(flags))
	rootCmd.AddCommand(newEntryPromotedCmd(flags))
	rootCmd.AddCommand(newEventStatusPromotedCmd(flags))
	rootCmd.AddCommand(newFixturesPromotedCmd(flags))
	rootCmd.AddCommand(newGamesJsonPromotedCmd(flags))
	rootCmd.AddCommand(newLeaguesH2hMatchesPromotedCmd(flags))
	rootCmd.AddCommand(newLhApi2PromotedCmd(flags))
	rootCmd.AddCommand(newLivefplapiPromotedCmd(flags))
	rootCmd.AddCommand(newLocalsLeagueIdJsonPromotedCmd(flags))
	rootCmd.AddCommand(newMePromotedCmd(flags))
	rootCmd.AddCommand(newMyTeamPromotedCmd(flags))
	rootCmd.AddCommand(newPricesJsonPromotedCmd(flags))
	rootCmd.AddCommand(newTeamPromotedCmd(flags))
	rootCmd.AddCommand(newTopTransfersJsonPromotedCmd(flags))
	rootCmd.AddCommand(newVersionJsonPromotedCmd(flags))
	rootCmd.AddCommand(newVersionCliCmd())

	// Manifest aliases (rank, prices, live, planner, top10k/eo, trending,
	// player, league, h2h, manager, dt, static, set-pieces). See aliases.go.
	applyManifestAliases(rootCmd)

	// Synthesized transcendence commands: explain, captain, chip-plan.
	// Built on top of the underlying endpoint commands; see transcendence.go.
	rootCmd.AddCommand(newExplainCmd(flags))
	rootCmd.AddCommand(newCaptainCmd(flags))
	rootCmd.AddCommand(newChipPlanCmd(flags))

	// Name-based lookup commands; see lookup.go.
	rootCmd.AddCommand(newPlayerLookupCmd(flags))
	rootCmd.AddCommand(newCompareCmd(flags))

	// Hermes-inspired extras; see extras.go.
	rootCmd.AddCommand(newCaptainsHistoryCmd(flags))
	rootCmd.AddCommand(newPointsCmd(flags))
	rootCmd.AddCommand(newCupCmd(flags))
