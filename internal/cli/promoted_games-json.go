...
func newGamesJsonPromotedCmd(flags *rootFlags) *cobra.Command {
	var flag string
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			path := "https://livefpl.us/api/games.json"
			params := map[string]string{}
			if flag != "" {
				params["_"] = fmt.Sprintf("%v", flag)
			}
			data, prov, err := resolveRead(cmd.Context(), c, flags, "games-json", false, path, params, nil)
			if err != nil {
	...
	cmd.Flags().StringVar(&flag, "", "", "Cache-busting epoch timestamp")
