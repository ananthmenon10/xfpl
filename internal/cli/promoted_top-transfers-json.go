...
func newTopTransfersJsonPromotedCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			path := "https://livefpl.us/top_transfers.json"
			params := map[string]string{}
			data, prov, err := resolveRead(cmd.Context(), c, flags, "top-transfers-json", false, path, params, nil)
			if err != nil {
