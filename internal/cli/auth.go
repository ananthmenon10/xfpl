...
func newAuthCmd(flags *rootFlags) *cobra.Command {
	cmd := &cobra.Command{
		Use:   "auth",
		Short: "Manage authentication for Livefpl",
...
func newAuthLogoutCmd(flags *rootFlags) *cobra.Command {
	return &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			envStillSet := ""
			if envStillSet == "" && os.Getenv("FANTASY_PREMIER_LEAGUE_SESSION_COOKIE") != "" {
				envStillSet = "FANTASY_PREMIER_LEAGUE_SESSION_COOKIE"
			}
