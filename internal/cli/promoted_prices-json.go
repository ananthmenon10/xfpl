...
func newPricesJsonPromotedCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			path := "https://livefpl.us/api/prices.json"
			params := map[string]string{}
			data, prov, err := resolveRead(cmd.Context(), c, flags, "prices-json", false, path, params, nil)
			if err != nil {
