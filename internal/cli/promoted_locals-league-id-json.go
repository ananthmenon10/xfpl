...
func newLocalsLeagueIdJsonPromotedCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			path := "https://livefpl.us/locals_{leagueId}.json"
			if len(args) < 1 {
			...
			data, prov, err := resolveRead(cmd.Context(), c, flags, "locals-league-id-json", false, path, params, nil)
			if err != nil {
