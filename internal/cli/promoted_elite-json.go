...
func newEliteJsonPromotedCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			path := "https://livefpl.us/elite.json"
			params := map[string]string{}
			data, prov, err := resolveRead(cmd.Context(), c, flags, "elite-json", false, path, params, nil)
			if err != nil {
