...
type Config struct {
	...
	Path                              string            `toml:"-"`
	FantasyPremierLeagueSessionCookie string            `toml:"premier_league_session_cookie"`
}
...
func Load(configPath string) (*Config, error) {
	...
	// Env var overrides
	if v := os.Getenv("FANTASY_PREMIER_LEAGUE_SESSION_COOKIE"); v != "" {
		cfg.FantasyPremierLeagueSessionCookie = v
		cfg.AuthSource = "env:FANTASY_PREMIER_LEAGUE_SESSION_COOKIE"
	}
	...
	if cfg.AuthSource == "" && cfg.FantasyPremierLeagueSessionCookie != "" {
		cfg.AuthSource = "config"
	}

	// Base URL override (used by printing-press verify to point at mock/test servers)
	if v := os.Getenv("LIVEFPL_BASE_URL"); v != "" {
		cfg.BaseURL = v
	}
	return cfg, nil
}
...
func (c *Config) AuthHeader() string {
	...
	token := c.FantasyPremierLeagueSessionCookie
	if token == "" {
		return ""
	}
	return token
...
func (c *Config) SaveCredential(token string) error {
	c.AuthHeaderVal = ""
	c.AccessToken = ""
	c.FantasyPremierLeagueSessionCookie = token
	return c.save()
}
...
func (c *Config) ClearTokens() error {
	...
	c.ClientID = ""
	c.ClientSecret = ""
	c.FantasyPremierLeagueSessionCookie = ""
	return c.save()
}
